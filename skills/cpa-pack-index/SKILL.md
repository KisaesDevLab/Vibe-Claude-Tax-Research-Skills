...
| Asks for workpaper scaffolds (PBC / prepared-by-client list, tickmark legend, lead sheets, alphanumeric indexing, audit / review / compilation engagement-file structure, AU-C §230 documentation, AR-C §60.A24 documentation, retention period) | `workpaper-templates` |
...
| `workpaper` / "carry into a workpaper" / "build a workpaper" / "PBC list" / "tickmark legend" / "lead sheets" / "indexing convention" | `workpaper-templates` (Phase 10b) — generates engagement-file scaffolds (PBC list, tickmarks, lead sheets, indexing) + audit / review / compilation variant overlays per AU-C §230, AR-C §60.A24, AT-C §105.A57. For procedural guidance on AU-C / AR-C / AT-C standards themselves, route also to `compliance-sas-audit`, `compliance-ssars`, or `compliance-attestation-qm` |
